<template>
  <div class="notification-bell" ref="bellContainer">
    <button class="bell-btn theme-transition" @click="toggleDropdown" :aria-label="$t('notifications.title')">
    ...
    <transition name="dropdown">
      <div v-if="isOpen" class="dropdown theme-transition">
        ...
        <div class="dropdown-body">
          ...
          >
            <div class="item-icon">
              <i v-if="notification.isAiAlert" class="pi pi-cog" aria-hidden="true"></i>
            ...
            <button class="item-dismiss" :aria-label="$t('notifications.dismiss')" @click.stop="$emit('dismiss', notification.id)"><i class="pi pi-times" aria-hidden="true"></i></button>
          </div>
        </div>
      </div>
    </transition>
