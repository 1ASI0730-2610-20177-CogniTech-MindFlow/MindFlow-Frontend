<template>
  <Layout>
    <div class="home-page theme-transition">
...
onMounted(() => {
  if (router.currentRoute.value.path === '/') {
    const hasVisited = localStorage.getItem('mindflow_visited')
    if (!hasVisited) {
      localStorage.setItem('mindflow_visited', 'true')
    }
  }
})
</script>
